...
object ServiceScreens {
    val all = listOf(
        ...
        ServiceScreenDefinition(
            screen = ServiceScreen.KEYS,
            title = "Key Programming",
            subtitle = "Read ISN, key slot data, key IDs, and VIN from CAS/EWS/FEM for key making.",
            targetId = "CAS",
            focusKeys = listOf("isn", "vin", "key_count", "key_slot_1", "key_slot_2", "key_slot_3", "key_slot_4"),
            actions = listOf(
                QuickServiceAction("Read key data", "CAS", "cas_read_key_slots"),
                QuickServiceAction("Read ISN", "CAS", "cas_read_isn"),
                QuickServiceAction("Read key ID", "CAS", "cas_read_key_id"),
                QuickServiceAction("Read VIN", "CAS", "cas_read_vin"),
            ),
        ),
