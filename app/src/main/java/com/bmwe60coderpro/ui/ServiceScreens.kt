...
object ServiceScreens {
    val all = listOf(
        ...
        ServiceScreenDefinition(
            ...
            title = "CAS service",
            subtitle = "Terminal state, start authorization, key presence, key slot data, ISN reading, and key programming data. Read key info directly from module memory without key present.",
            targetId = "CAS",
            focusKeys = listOf("terminal_flags", "key_presence_flags", "start_authorization_flags", "key_slot_status", "isn", "key_count", "key_slot_1", "key_slot_2", "key_slot_3", "key_slot_4"),
            actions = listOf(
                ...
                QuickServiceAction("Read key data", "CAS", "cas_direct_read_key_memory"),
                QuickServiceAction("Read ISN", "CAS", "cas_direct_read_isn"),
